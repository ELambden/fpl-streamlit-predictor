        ...
        rows.append(
            {
                ...
                "bonus": _as_int(player.get("bonus")),
                "bps": _as_int(player.get("bps")),
                "defensive_contribution": _as_float(player.get("defensive_contribution")),
                "defensive_contribution_per_90": _as_float(player.get("defensive_contribution_per_90")),
            ...
            rows.append(
                {
                    ...
                    "bonus": _as_int(item.get("bonus")),
                    "bps": _as_int(item.get("bps")),
                    "defensive_contribution": _as_float(item.get("defensive_contribution")),
